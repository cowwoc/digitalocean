...
/**
 * A type-safe identifier for a container image.
 */
public final class ContainerImageId extends StringId
{
	/**
	 * Creates a ContainerImageId.
	 *
	 ...
	 */
	public static ContainerImageId of(String value)
	{
		if (value == null)
			return null;
		return new ContainerImageId(value);
	}

	/**
	 * Creates a ContainerImageId.
	 *
	 * @param value the server-side identifier for a container image
	 ...
	 *                                  </ul>
	 */
	private ContainerImageId(String value)
	{
		super(value);
	...
	{
		return o instanceof ContainerImageId other && super.equals(other);
	}
}